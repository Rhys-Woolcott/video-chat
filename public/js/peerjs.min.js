		...
		kdPp: [
			function(require, module, exports) {
				...
				Unpacker.prototype.unpack_uint64 = function() {
					...
					var uint64 =
						((((((bytes[0] * 256 + bytes[1]) * 256 + bytes[2]) * 256 + bytes[3]) * 256 + bytes[4]) * 256 +
							bytes[5]) *
							256 +
							bytes[6]) *
							256 +
				...
				var Socket =
					...
					(function(_super) {
						...
						Socket.prototype._sendQueuedMessages = function() {
							...
							try {
								for (
									var copiedQueue_1 = __values(copiedQueue), copiedQueue_1_1 = copiedQueue_1.next();
				...
				var MediaConnection =
					...
					(function(_super) {
						...
						function MediaConnection(peerId, provider, options) {
							...
							_this.connectionId =
								_this.options.connectionId || MediaConnection.ID_PREFIX + util_1.util.randomToken();
   ...
   */
     ...
     */
						...
						Peer.prototype.getConnection = function(peerId, connectionId) {
							...
							try {
								for (
									var connections_1 = __values(connections), connections_1_1 = connections_1.next();
     ...
     */
						...
						Peer.prototype._cleanupPeer = function(peerId) {
							...
							try {
								for (
									var connections_2 = __values(connections), connections_2_1 = connections_2.next();
